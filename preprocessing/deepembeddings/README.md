# Siamese network and triplet loss embeddings compatible with sklearn.

Sklearn interfaced triplet loss and siamese network based on [6] using early stopping from [7].
...
[6] Adam Bielski, [Siamese and triplet learning with online pair/triplet mining](https://github.com/adambielski/siamese-triplet).

[7] Bjarte Mehus Sunde, [Early Stopping for PyTorch](https://github.com/Bjarten/early-stopping-pytorch).
